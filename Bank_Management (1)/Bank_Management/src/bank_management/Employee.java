...
public class Employee {
    ...
    Employee(String name, String phone, String email, String password, double salary, String department) {
        this.name =name;
    ...
    public void Creat_Employee(String name, String phone, String email, String password, String department, double salary){
         Employee employe=new Employee(name,phone,email,password,salary, department);
